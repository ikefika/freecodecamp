/* Lesson 9: Extract Local State into Redux
...
class Presentational extends React.Component {
  constructor(props) {
    super(props);
    // messages: []   Removed from local state, now managed by Redux
    this.state = {
      input: ''
    }
  ...
  /*modify the submitMessage() method so that it dispatches submitNewMessage() from this.props, and pass in the current message input from local state as an argument. Because you removed messages from local state, remove the messages property from the call to this.setState() here as well.
  */
  submitMessage() {
